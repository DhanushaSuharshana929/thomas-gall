                            ...
                            <aside class="sidebar">
                                ...
                                <div class="sidebar-widget category-widget">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="language.php">Language Academy <span></span></a></li>
                                        <a class="read-more" href="learning.php">View More <span class="icon fa fa-angle-right"></span></a>
                                    </ul>
                                </div>
