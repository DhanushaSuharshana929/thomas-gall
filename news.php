                            ...
                            <section class="blog-classic">
                                ...
                                <div class="news-style-four">
                                    <div class="inner-box">
                                        <!--Image Column-->
                                        <div class="image">
                                            <a href="news-single.php"><img src="images/resource/news-11.jpg" alt="" /></a>
                                        </div>
                                        <!--Content Column-->
                                ...
                                <div class="news-style-four">
                                    <div class="inner-box">
                                        <!--Image Column-->
                                        <div class="image">
                                            <a href="news-single.php"><img src="images/resource/news-12.jpg" alt="" /></a>
                                        </div>
                                        <!--Content Column-->
                                        <div class="content-column">
                                            <div class="inner">
                                ...
                                <div class="news-style-four">
                                    <div class="inner-box">
                                        <!--Image Column-->
                                        <div class="image">
                                            <a href="news-single.php"><img src="images/resource/news-13.jpg" alt="" /></a>
                                        </div>
                                        <!--Content Column-->
                                        <div class="content-column">
                                            <div class="inner">
                                ...
                                <div class="news-style-four">
                                    <div class="inner-box">
                                        <!--Image Column-->
                                        <div class="image">
                                            <a href="news-single.php"><img src="images/resource/news-14.jpg" alt="" /></a>
                                        </div>
                                        <!--Content Column-->
                                        <div class="content-column">
                                            <div class="inner">
